...
**Scalable VPC Architecture on AWS** [[GitHub](https://github.com/kaustubhspatil/Scalability-of-VPC-Architecture-on-AWS)]: Designed and deployed a modular, scalable, and secure virtual network infrastructure on AWS using Amazon VPC. Implemented public and private subnets across multiple availability zones, configured NAT gateways, route tables, and security groups, and applied infrastructure-as-code principles to enable repeatable provisioning of a production-ready cloud network foundation.
...
**Dr. D. Y. Patil University (July 2023)**, Bachelor of Technology, Data Science and Bioinformatics
